...
public class Student {
  ...
  // 1. If you want to contral the access to setter after the object created, builder pattern is a good choice
  // 2. You don't have to create too much contrucators, according to the attributes
