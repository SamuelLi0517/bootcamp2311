...
Integer i3 = 10;
System.out.println(i1 == i3);// true, Integer Cahe (-128 to 128)

Integer i4 = 127;
Integer i5 = 127;
System.out.println(i4 == i5);// true, Integer cahe (-128 to 127)

Integer i6 = 128;
Integer i7 = 128;
System.out.println(i6 == i7);// false, out of Integer Cahe
