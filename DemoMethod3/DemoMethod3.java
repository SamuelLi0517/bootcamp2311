...
System.out.println("before AddOne(): "+ Arrays.toString(beforeArr));// [3, 5, 10]
int [] afterArr = addOne(beforeArr);
System.out.println("after AddOne():"+ Arrays.toString(beforeArr));// [4, 6, 11]
System.out.println("after AddOne():"+ Arrays.toString(afterArr));// [4, 6, 11]
